 ...
 * Developer: Pawan Sindhwal
 * Copyright: © 2018-2022 Artios Media (email : contact@artiosmedia.com).
...
define( 'PRODUCT_CODE_VERSION', '1.3.2-beta' );
define( 'PRODUCT_CODE_DB_VERSION', '1.3.2-beta' );
...
/*
Deprecated Function in version 1.2.6
add_action('save_post', 'on_product_save', 10000, 3);

function on_product_save( $post_id, $post, $update ) {
 ...
 delete_post_meta($post_id,'_product_code');
     foreach($variations_id as $var){
         echo $ProductCode = get_post_meta($var,"_product_code",true);
