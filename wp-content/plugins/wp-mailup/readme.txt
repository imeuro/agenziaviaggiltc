...
= 1.4.12 =
* FIX: use plugin_dir_url() to resolve subscribe.php path. Resolves mixed-content issue when site is https.
...
= 1.4.12 =
* FIX: usa plugin_dir_url() per risolvere il percorso di subscribe.php. Risolve l'eccezione di mixed-content quanto il sito è in https.
